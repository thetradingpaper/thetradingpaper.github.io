...
(function () {
  ...
  var css = ''
    ...
    + '@media print{header.tpm,#tpm-sticky,nav.tpm-subnav,.tpm-pagetitle,.no-print,nav,button,.tp-arch,.tp-archwrap,#tp-gate{display:none!important;}html,body{overflow:visible!important;background:#fff!important;color:#000!important;}.wrap,.container,main{max-width:100%!important;width:100%!important;padding:0!important;margin:0!important;}.total-hero,.book-header,.alloc-mountain,.awaiting-row,.rules-box,.hcard,.hcards,table,tr,.card,.widget{break-inside:avoid;page-break-inside:avoid;}}'
